...
class SellerVerificationController extends Controller
{
    ...
    public function verifyFree(Request $request)
    {
        $request->validate([
            'seller_id'           => 'required|exists:sellers,id',
            'verification_number' => 'required|string|max:255',
        ]);
        ...
        SellerVerificationPayment::create([
            'seller_id'           => $seller->id,
        ...
        return response()->json([
            'success' => true,
            'message' => 'Verification number submitted successfully. Your account will be reviewed shortly.',
        ]);
    }
}
