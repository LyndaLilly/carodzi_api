...
class AdminOtherProfileController extends Controller
{
    ...
    // ✅ Admin creates OtherProfile for a seller
    public function store(Request $request, $sellerId)
    {
        $rules = [
            ...
            'business_email'        => 'nullable|email|unique:other_profiles,business_email',
    ...
    // ✅ Admin updates OtherProfile for a seller
    ...
    // ✅ Admin view OtherProfile for a seller
